...
<br style="line-height: 1px;">
                            ...
                            <TABLE class="inputbl" id="queryPane" cellSpacing="1" cellPadding="1" width="100%" align="center"
                                ...
                                <TR>
                                    <TD id="tdLogo" class="logontitle" width="14%" rowSpan="6">
                                        <DIV align="center">
                                            <P class="zteLightBlue" align="center"><span id="lblCompanyBill">国内差旅费单</span></P>
                                        </DIV>
                                    </TD>
                                ...
                                <TR>
                                    ...
                                    <TD align="left" bgColor="#efefef"><%= bClaim.getProductName()%></span></TD>
                                </TR>
                                <tr>
	...
	<TABLE width="100%" align="center" id="tblMainInfo" bgColor="#1475b3" class="inputbl" border="0" cellPadding="0" cellSpacing="0">
        ...
        <tr><td class="title" nowrap="nowrap"><div align="left">日期起<font color="red">*</font></div>
        	  </td><td class="title" nowrap="nowrap"><div align="left">日期止<font color="red">*</font></div></td>
        	  	<td class="title" nowrap="nowrap"><div align="left" nowrap="nowrap">出发城市<font color="red">*</font></div></td>
        	  	<td class="title" nowrap="nowrap"><div align="left">出差省份<font color="red">*</font></div></td>
        	  	<td class="title" nowrap="nowrap"><div align="left">出差市/县</div></td>
        	  	<td class="title" nowrap="nowrap"><div align="left">交通工具<font color="red">*</font></div></td>
        	  	<td class="title" nowrap="nowrap"><div align="left">交通费<font color="red">*</font></div></td>
