...
<SCRIPT language=javascript>
			...
			function setClickFlag()
			{
		        ...
		        function query()
                        {
        	            Form1.action = "generalManager.do?action=query";
        	            Form1.submit();
                        }
...
<TD class=title>
      <DIV align=left noWrap><SPAN id=productxx>所属项目</SPAN></DIV>
</TD>
 <TD>
     <SELECT size="0" style="WIDTH: 180px" id=product name=product>    
        <OPTION value=""></OPTION>
        <%   
        ...
        <TR class=head>
               ...
               if(ifhavebox() == 1)
                 {
                  var appFlag = 0;
                   ...
                   Form1.action = "generalManager.do?action=permit";
                   Form1.submit();
                    }  
                }
               else
               ...
               if(ifhavebox() == 1)
                 {
                  var appFlag = 0;
                   ...
                   {
                   window.top.needAlert = true; 
                   Form1.action = "generalManager.do?action=notPermit";
                   Form1.submit();
                    }  
                }
               else
  	   ...
  	   %>  	
          ...
          <TD noWrap  align=left>
          	<a href="invoiceDetailGM.do?InvoiceNoDe=<%= countersignMap.get(key).getInvoiceNo()%>">
