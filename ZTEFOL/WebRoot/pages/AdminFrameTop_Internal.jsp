      ...
      <TABLE id=header cellSpacing=0 cellPadding=0>
        ...
        <TR>
          <TD vAlign=top align=left>
            ...
            align=left>
              ...
              <TR>
                ...
                <TD style="COLOR: #a8a8a8" title=主页 noWrap><A 
                  onclick="try{top.right.location.href= 'index_files/AdminIndex.html';}catch(exception){window.open('../Redirect.aspx?pageCode=main&amp;toolbarId=toolbar.001','u','scrollbars=yes,resizable=yes,dependent,width='+(screen.availWidth-300)+',height='+(screen.availHeight-200)+',left=0,top=0')}" 
                  href="AdminFrameTop_Internal.jsp">首页</A></TD>
                <TD class=vline1>&nbsp;&nbsp;&nbsp;</TD>               
            ...
            <IFRAME height=23 marginHeight=0 src="FrameTop_Internal_files/AdminFrameMenuTop.htm" frameBorder=0 width="100%" name=news marginWidth=0 scrolling=no>
            	</IFRAME>
            	</DIV>
            	</TD>
