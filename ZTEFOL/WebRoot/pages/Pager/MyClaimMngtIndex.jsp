					...
					<TR height=24>
						<TD>
							...
							<SPAN id=TableHeadBar1_lblHead>当前位置<SPAN class=11air>:</SPAN>与我有关<SPAN
								class=arrow_subtitle>&gt;</SPAN>我的单据<SPAN class=arrow_subtitle>&gt;</SPAN>我报销的</SPAN>
						</TD>
						...
						<TR>
							...
							<TD>
								<select id="statusID" name="statusID" style="WIDTH: 170px">
									<!--0：草稿，1：待业务审批，2：待领导会签，3：待财务审批，4：关闭，5：被退回后的状态  -->
								...
								<TBODY>
									<TR class=head>
										<TD style="WIDTH: 8%" noWrap align=left>
											<A
												href="javascript:__doPostBack('dgApproval$_ctl1$_ctl0','')">单据号</A>
										</TD>
										<TD style="WIDTH: 8%" noWrap align=left>
											<A
												href="javascript:__doPostBack('dgApproval$_ctl1$_ctl1','')">报销部门</A>
										</TD>
										<TD style="WIDTH: 8%" noWrap align=left>
											<A
												href="javascript:__doPostBack('dgApproval$_ctl1$_ctl2','')">报销人</A>
										</TD>
										<TD style="WIDTH: 8%" noWrap align=left>
											<A
												href="javascript:__doPostBack('dgApproval$_ctl1$_ctl3','')">所属项目</A>
										</TD>
										<TD style="WIDTH: 8%" noWrap align=left>
											<A
												href="javascript:__doPostBack('dgApproval$_ctl1$_ctl4','')">提交日期</A>
										</TD>
										<TD style="WIDTH: 8%" noWrap align=left>
											<A
												href="javascript:__doPostBack('dgApproval$_ctl1$_ctl5','')">单据类型</A>
										</TD>
										<TD style="WIDTH: 8%" noWrap align=left>
											<A
												href="javascript:__doPostBack('dgApproval$_ctl1$_ctl6','')">审批状态</A>
										</TD>
										<TD style="WIDTH: 8%" noWrap align=left>
											<A
												href="javascript:__doPostBack('dgApproval$_ctl1$_ctl7','')">审批结束日期</A>
										</TD>
										<TD style="WIDTH: 8%" noWrap align=left>
											<A
												href="javascript:__doPostBack('dgApproval$_ctl1$_ctl8','')">票据号码</A>
										</TD>
										<TD style="WIDTH: 8%" noWrap align=left>
											<A
												href="javascript:__doPostBack('dgApproval$_ctl1$_ctl9','')">摘要</A>
										</TD>
										<TD style="WIDTH: 8%" noWrap align=left>
											<A
												href="javascript:__doPostBack('dgApproval$_ctl1$_ctl10','')">申请金额</A>
										</TD>
										<TD style="WIDTH: 8%" noWrap align=left>
											<A
												href="javascript:__doPostBack('dgApproval$_ctl1$_ctl11','')">审核金额</A>
										</TD>
									</TR>
