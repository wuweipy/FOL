...
<HTML>
    ...
    <body>
        <form name="Form1" method="post" action="invoiceDetail.do">
    ...
    <tbody>
        <tr height="24">
            <td>
                ...
                <span id="TableHeadBar1_lblHead">当前位置<SPAN class="11air">:</SPAN>与我有关<span class="arrow_subtitle">&gt;</span>单据审批<span class="arrow_subtitle">&gt;</span>所长审批</span>
            </td>
           ...
           { 
             ...
             if(appCommentIsNull())
              ...
              if(appFlag==1)
              {
               ...
               Form1.action = "countersign.do?action=permitone"; 
               Form1.submit();
               }                     
          }
          ...
          function notPermit()                         
           { 
             ...
             if(appCommentIsNull())
              ...
              {
               window.top.needAlert = true;
               Form1.action = "countersign.do?action=notPermitone"; 
               Form1.submit();
               }                     
          }
