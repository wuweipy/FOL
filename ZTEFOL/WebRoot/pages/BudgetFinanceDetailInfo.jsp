...
<TABLE style="WIDTH: 100%; BORDER-COLLAPSE: collapse" id="tbNullMsg" class="datatbl" border="1" rules="all" cellspacing="0">
  <TBODY>
        ...
        <TR id=tr_Head class=head>
          ...
          <TD noWrap  align=left>所长审批意见</TD>
          <TD noWrap  align=left>财务审批意见</TD>
       </TR>              
             ...
             {                          
                    if(confirm("您确认要提交审批吗?"))
                    {
                      ...
                      for(var i=0; i < itemNum; i++ )
                      {
                        ...
                        varStr += "&financeOpinion"+i+"=";
                        varStr += document.getElementById("financeOpinion"+i).value;
                      }
                      Form1.action = "budgetFinanceDetailServlet.do?" + varStr;
                      Form1.submit();
                    }                                         
             }
  	  ...
  	  %>
  	    <TR class=item>
            ...
            <TD noWrap align=left>
          	<input HEIGHT: 20px" id=financeOpinion<%= i%> name=financeOpinion<%= i%>>
            </TD>                    
         </TR>
